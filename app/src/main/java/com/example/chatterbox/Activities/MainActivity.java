...
import com.example.chatterbox.Adapter.RecentConversionAdapter;
...
public class MainActivity extends BaseActivity implements ConversionListeners {
    ...
    private RecentConversionAdapter conversationsAdapter;
    ...
    private void init(){
        ...
        conversationsAdapter=new RecentConversionAdapter(conversations,this);
